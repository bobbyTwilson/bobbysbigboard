...
(function(){
  ...
  function ensureStyles(){
    ...
    s.textContent=`
      ...
      #plusView .bbbcc-pulse span{display:block;color:#60736a;font-size:6px;font-weight:950;letter-spacing:.08em;text-transform:uppercase;margin-bottom:5px}
      #plusView .bbbcc-pulse strong{display:block;color:#e7eee9;font-size:13px;line-height:1.1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
      ...
      #plusView .bbbcc-action{display:inline-flex;align-items:center;justify-content:center;min-height:35px;padding:0 12px;border:1px solid #29473a;border-radius:8px;background:#08120e;color:#a9b8b0;text-decoration:none;font-size:7.5px;font-weight:950;letter-spacing:.04em}
      ...
      #plusView .bbbcc-player-name strong{display:block;color:#f2f6f3;font-size:15px;line-height:1.1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
      ...
      #plusView .bbbcc-rank span{display:block;color:#60736a;font-size:5.8px;font-weight:950;letter-spacing:.06em;text-transform:uppercase;margin-bottom:4px}
      #plusView .bbbcc-rank strong{display:block;color:#dfe8e2;font-size:13px}
      ...
      #plusView .bbbcc-spark-top span{color:#60736a;font-size:5.8px;font-weight:950;letter-spacing:.06em;text-transform:uppercase}
      #plusView .bbbcc-spark-top strong{font-size:8px}
      ...
      #plusView .bbbcc-update time{flex:none;color:#64d99d;font-size:6.5px;font-weight:950;text-transform:uppercase;letter-spacing:.05em;padding-top:1px}
      #plusView .bbbcc-update p{margin:0;color:#9dadA5;font-size:8px;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
      #plusView .bbbcc-player-foot{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:10px}
      #plusView .bbbcc-market-view{display:inline-flex;border-radius:999px;border:1px solid #29463a;background:#09140f;color:#a0b0a8;padding:4px 7px;font-size:6px;font-weight:950}
      ...
      #plusView .bbbcc-panel-head span{color:#60736a;font-size:6px;font-weight:950;letter-spacing:.07em;text-transform:uppercase}
      ...
      #plusView .bbbcc-edge-player strong{display:block;color:#e8efeb;font-size:9px}
      #plusView .bbbcc-edge-player span{display:block;color:#65786d;font-size:6.7px;margin-top:2px}
      #plusView .bbbcc-edge-col{text-align:right}
      #plusView .bbbcc-edge-col span{display:block;color:#5e7167;font-size:5.5px;font-weight:950;text-transform:uppercase;margin-bottom:3px}
      ...
      #plusView .bbbcc-tool strong{display:block;color:#eaf1ed;font-size:10px}
      #plusView .bbbcc-tool small{display:block;color:#687b71;font-size:7px;line-height:1.45;margin-top:4px}
