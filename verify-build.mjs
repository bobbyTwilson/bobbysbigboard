...
const requiredFiles=[
  'index.html','bbb-core.js','supabase-override.js','profile-overview-fix.js','updates-section.js','movers-section.js','compare-section.js','profile-v2.js','profile-v2-data-fix.js','profile-college.js','trade-v2.js','advanced-filters.js','watchlist.js','nav-polish.js','profile-snapshot.js','profile-polish.js','global-search.js','search-polish.js','opportunity-feed.js','homepage-structure.js','seo-social.js','sitemap.xml','robots.txt'
];
...
console.log(`Build smoke checks passed: canonical runtime present, Watchlist V1, consolidated desktop/mobile Explore navigation, homepage hierarchy polish, deduplicated Profile Snapshot V1, Player Timeline V2, Opportunity Feed V1, and final profile composition guard bundled and syntax-valid, zero Google Sheets runtime references, ${playerUrls} player routes, and all primary BBB tools routed.`);
