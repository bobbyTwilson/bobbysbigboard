...
const requiredFiles=[
  'index.html','bbb-core.js','supabase-override.js','profile-overview-fix.js','updates-section.js','movers-section.js','compare-section.js','profile-v2.js','profile-v2-data-fix.js','profile-college.js','trade-v2.js','advanced-filters.js','watchlist.js','nav-polish.js','profile-snapshot.js','profile-polish.js','global-search.js','search-polish.js','opportunity-feed.js','seo-social.js','sitemap.xml','robots.txt'
];
...
const requiredHtmlMarkers=[
  'id="rankingsView"','id="rookieView"','id="prospectView"','id="tradeView"','id="profileView"','id="bbb-runtime-script"','src="/bbb-core.js"','src="/supabase-override.js"','src="/updates-section.js"','src="/compare-section.js"','src="/profile-v2.js"','src="/trade-v2.js"','src="/advanced-filters.js"','src="/watchlist.js"','src="/nav-polish.js"','src="/profile-snapshot.js"','src="/profile-polish.js"','src="/global-search.js"','src="/search-polish.js"','src="/opportunity-feed.js"'
];
...
for(const marker of ['bbb-nav-explore','Explore','Opportunity Feed','Compare Players','bbbNavPolishDesktop']){
...
console.log(`Build smoke checks passed: canonical runtime present, Watchlist V1, streamlined navigation, deduplicated Profile Snapshot V1, Player Timeline V2, Opportunity Feed V1, and final profile composition guard bundled and syntax-valid, zero Google Sheets runtime references, ${playerUrls} player routes, and all primary BBB tools routed.`);
